...
const PHONE = '27646437107'
const MESSAGE = encodeURIComponent("Hi TNM Irrigation, I'd like to get a quote for irrigation in Cape Town.")
...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <span
        className="text-white font-semibold text-sm whitespace-nowrap overflow-hidden transition-all duration-300"
        style={{
