...
export default {
  ...
  title: 'How to Build an Ideal Customer Profile',
  description:
    'A practical guide to building an ideal customer profile from your best clients: the fields that matter, the trigger that signals readiness, how to validate it, and why vague targeting sinks outreach.',
  intro:
  ...
  faqs: [
    {
      ...
      a: 'An ideal customer profile describes the type of company that fits best: its size, industry, and the trigger that makes it ready. A buyer persona describes the individual inside that company you sell to, including their role, goals, and objections. You need both. The profile tells you which accounts to pursue, and the persona tells you who to talk to and what to say once you are in.',
    },
    {
      q: 'How many fields should an ICP have?',
      a: 'Fewer than you think. A profile built on a handful of fields you can actually verify beats a long one full of guesses. Company size, industry, the role you sell to, and the trigger that signals readiness carry most of the weight. Add a field only if it changes who makes the list. If it does not change your targeting, it is noise.',
    },
    {
      q: 'What is a buying trigger and why does it matter?',
      a: 'A trigger is a specific, observable event that moves a company from a someday buyer to a now buyer. Examples include a new sales leader, a recent funding round, a hiring spree, or a compliance deadline. Fit tells you a company could buy. A trigger tells you they are ready soon, which is most of what makes outreach land. It is the field teams skip most and the one that helps most.',
    },
    {
      q: 'How do I know if my ICP is right?',
      a: 'Test it against real outcomes. Score your existing pipeline and check whether accounts that match the profile close at a higher rate, close faster, and stay longer than accounts that do not. Then run outreach to a matched batch and an unmatched batch and compare reply and meeting rates. If the matched accounts perform clearly better, the profile is working. If not, a field is wrong.',
    },
    {
      q: 'How often should I update my ICP?',
      a: 'Treat it as a living document and revisit it every quarter. As you win and lose deals, patterns shift, your product improves, and the accounts that fit best change over time. A profile nobody checks quietly goes stale and starts steering your team toward the wrong accounts. A quick quarterly review against recent wins keeps it honest.',
    },
    {
  ...
  related: [
    { to: '/lead-qualification-framework', label: 'Lead Qualification: A Practical Framework', desc: 'Turn the profile into a repeatable qualification standard.' },
    { to: '/how-to-write-a-cold-email', label: 'How to Write a Cold Email That Gets Replies', desc: 'The message a sharp profile lets you write.' },
    { to: '/how-to-book-more-sales-meetings', label: 'How to Book More Sales Meetings', desc: 'Where the targeting work pays off.' },
    { to: '/b2b-appointment-setting-services', label: 'B2B Appointment Setting Services', desc: 'What it looks like to have this run for you.' },
  ],
  ctaHeading: 'Not sure who your best-fit accounts really are?',
  ctaBody: 'We help you build the profile from your best clients, then run the targeting and outreach against it and book qualified meetings into your calendar. One call is enough to see if it fits.',
}
